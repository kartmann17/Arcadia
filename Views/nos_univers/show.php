...
<div class="vide"></div>
    ...
    <p class="card-text">Prénom : <?= htmlspecialchars($animal->name) ?></p>
    <p>Espèce : <?= htmlspecialchars($animal->species_id ?? 'Inconnue') ?></p>
    <p>Etat :<?= htmlspecialchars($report->health_state) ?></p>